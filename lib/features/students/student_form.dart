...
class Student {
  ...
  Student(this.id, this.name, this.className, this.option, this.gender, this.parent, this.address);
}

class StudentForm extends StatefulWidget {
  final Function(Student) onAdd; // Callback function for adding a student
...
class _StudentFormState extends State<StudentForm> {
  ...
  void _submitForm() {
    if (_formKey.currentState?.validate() == true) {
      ...
      Student newStudent = Student(id, fullName, className, 'Unknown', gender, parentInfo, addressInfo);
